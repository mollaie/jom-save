...
/* harmony import */ var _complaints_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./complaints.page */ "./src/app/pages/profile/complaints/complaints.page.ts");
...
var routes = [
    {
        path: '',
        component: _complaints_page__WEBPACK_IMPORTED_MODULE_6__["ComplaintsPage"]
    }
];
var ComplaintsPageModule = /** @class */ (function () {
    function ComplaintsPageModule() {
    }
    ComplaintsPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/***/ "./src/app/pages/profile/complaints/complaints.page.html":
/*!***************************************************************!*\
  !*** ./src/app/pages/profile/complaints/complaints.page.html ***!
  \***************************************************************/
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL3Byb2ZpbGUvY29tcGxhaW50cy9jb21wbGFpbnRzLnBhZ2Uuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/pages/profile/complaints/complaints.page.ts":
/*!*************************************************************!*\
  !*** ./src/app/pages/profile/complaints/complaints.page.ts ***!
  \*************************************************************/
...
var ComplaintsPage = /** @class */ (function () {
    function ComplaintsPage(platform, api, restApi, alert, dataTransaction, routerProvider, router) {
        var _this = this;
    ...
    ComplaintsPage.prototype.doNext = function () {
        var _this = this;
        if (!this.isDebug) {
            this.api.AddComplaint(this.Model.Title, this.Model.Body, this.AccessToken)
                ...
                if (response.status == 200) {
                    ...
                    if (result.ErrorCode == "0") {
                        _this.alert.showErrorMessageAlert('We would like to extend to you our most sincere apologies regarding the negative experience you had with JomSave.we will investigate and respond to your complaint within 5 working days.');
    ...
    ComplaintsPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-complaints',
            template: __webpack_require__(/*! ./complaints.page.html */ "./src/app/pages/profile/complaints/complaints.page.html"),
            styles: [__webpack_require__(/*! ./complaints.page.scss */ "./src/app/pages/profile/complaints/complaints.page.scss")]
        }),
