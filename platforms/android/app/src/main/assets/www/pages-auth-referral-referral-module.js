...
var ReferralPage = /** @class */ (function () {
    function ReferralPage(dataTransaction, router, zbar, api, routeProvider, platform, loading, restApi, alert, alertCtrl) {
        var _this = this;
    ...
    ReferralPage.prototype.doSetUpline = function () {
        ...
        if (!this.isDebug) {
            ...
            this.restApi.SetUpline(this.UserInfo.UserId, this.AccessToken).subscribe(function (response) {
                var result = _this.restApi.converResponseToJson(response);
                if (result.ErrorCode == "0") {
                    _this.routeProvider.nextStep(result.Data.NextStep);
                }
    ...
    ReferralPage.prototype.doCheckValue = function (event) {
        var reg = /([a-z])/;
    ...
    ReferralPage.prototype.doValidate = function () {
        if (this.Model.Referral.length == 0) {
            this.alert.showErrorMessageAlert('Please fill in the Referral ID');
            return false;
        }
    };
    ReferralPage.prototype.presentConfirm = function (member, memberId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
